...
namespace backend\gii\generators\mcrud\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = \backend\lib\Controller::class;
    ...
    {
        return 'Metronic CRUD Generator';
    }
    ...
    public function getDescription()
    {
        return 'This generator generates a controller and views that implement CRUD (Create, Read, Update, Delete)
            operations for the specified data model. METRONIC.';
    }
