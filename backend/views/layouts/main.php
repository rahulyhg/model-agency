            ...
            <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
                <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                        <a href="<?= Url::to(['/bulletin']) ?>" class="m-menu__link m-menu__toggle">
                            <i class="m-menu__link-icon flaticon-notes"></i>
                            <span class="m-menu__link-text">Объявления</span>
                        </a>
                    </li>
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <?php foreach ($this->params['actions'] as $action) : ?>
                            <a href="<?= $action['url'] ?>" class="btn btn-<?= $action['type'] ?: 'default' ?> m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">
                                <span>
