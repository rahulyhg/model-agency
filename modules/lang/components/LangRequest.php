...
class LangRequest extends Request
{
  ...
  public function getLangUrl()
  {
    if ($this->_lang_url === null) {
      ...
      if( $lang_url !== null && $lang_url === Lang::getCurrent()->ietf_tag &&
        strpos($this->_lang_url, Lang::getCurrent()->ietf_tag) === 1
        && !Lang::getCurrent()->is_default)
      {
        $this->_lang_url = substr($this->_lang_url, strlen(Lang::getCurrent()->ietf_tag)+1);
      }
    }
