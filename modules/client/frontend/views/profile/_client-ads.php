 ...
 * @var $models \modules\bulletin\common\models\Bulletin[]
 */
?>
          ...
          <article class="b-first-announcement b-my-ads__item" itemscope
            ...
            <main class="b-first-announcement__main">
              <div class="b-first-announcement__top">
                ...
                <span class="b-first-announcement__price" itemprop="price" content="84300.00">84 300</span>
              ...
              <p class="b-first-announcement__category">
                ...
                <span class="b-first-announcement__category-item" itemprop="category">Легковые автомобили</span>
              </p>
              <div class="b-first-announcement__bottom">
                <span class="b-first-announcement__location" title="Киев, Киевская область, Украина">
                    <i class="b-first-announcement__icon pe-7s-map-marker"></i> Киев, Киевская область
                </span>
                <time class="b-first-announcement__date" datetime="2018-10-09">
                  <i class="b-first-announcement__icon pe-7s-clock"></i> Вчера 18:34
                </time>
              </div>
            </main>
        ...
        <article class="b-first-announcement b-my-ads__item" itemscope
          ...
          <main class="b-first-announcement__main">
            <div class="b-first-announcement__top">
              ...
              <p class="b-first-announcement__offer" itemprop="offers">
                                                                    <span class="b-first-announcement__price"
                                                                          itemprop="price"
                                                                          content="84300.00">84
                                                                        300</span>
