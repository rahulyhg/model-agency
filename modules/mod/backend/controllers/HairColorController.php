...
use modules\mod\common\models\HairColorSearch;
...
class HairColorController extends Controller
{
    ...
    {
        $searchModel = new HairColorSearch();
    ...
    /**
    * Deletes an existing HairColor models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    ...
    */
     ...
     * @param integer $id
     * @return HairColor the loaded model
