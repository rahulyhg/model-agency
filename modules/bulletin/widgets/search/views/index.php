...
<?php $form = ActiveForm::begin([
  'action' => \yii\helpers\Url::to(['/bulletin/default/search']),
  'method' => 'GET',
  'options' => [
    'class' => 'b-search ' . $elementClass
  ],
  'fieldConfig' => [
    'options' => [
      'tag' => false,
  ...
  <label for="search-inquiry" class="b-field b-search__field">
    <?= $form->field($model, 'query')->label(false)->textInput([
      ...
      'autocomplete' => 'off',
      'maxlength' => true,
      'placeholder' => Yii::t('header', 'Поиск по фразам')
    ]) ?>
  </label>
  ...
  <button type="submit" class="b-button-second b-search__button">
      <span class="b-button-second__value b-button-second__value_bold b-button-second__value_lighten"><?= Yii::t('header', 'Найти') ?></span>
  </button>
<?php ActiveForm::end() ?>