...
/**
* ServiceBulletinController implements the CRUD actions for ServiceBulletin model.
*/
class ServiceBulletinController extends Controller
{
    ...
    */
    ...
    /**
    * Lists all ServiceBulletin models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel = new ServiceBulletinSearch();
    ...
    /**
    * Creates a new ServiceBulletin model.
    * If creation is successful, the browser will be redirected to the 'update' page.
    * @return mixed
    */
    public function actionCreate()
    {
        $model = new ServiceBulletin();
    ...
    /**
    * Updates an existing ServiceBulletin model.
    ...
    */
    ...
    /**
    * Deletes an existing ServiceBulletin model.
    ...
    */
    ...
    /**
    * Deletes an existing ServiceBulletin models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    ...
    */
    ...
    /**
    * Finds the ServiceBulletin model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return ServiceBulletin the loaded model
    * @throws NotFoundHttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = ServiceBulletin::findOne($id)) !== null) {
            return $model;
        }
    ...
    */
    ...
    {
        $models = ServiceBulletin::findAll($ids);
        if (!empty($models)) {
            return $models;
        }
        throw new NotFoundHttpException('The requested page does not exist.');
