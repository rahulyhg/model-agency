...
class Generator extends \yii\gii\Generator
{
    ...
    public $baseControllerClass = 'backend\lib\Controller';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'modelClass', 'searchModelClass', 'baseControllerClass', 'singularEntityName', 'indexPageTitle'], 'filter', 'filter' => 'trim'],
            ...
            [['singularEntityName', 'indexPageTitle'], 'string'],
            ['viewPath', 'safe'],
        ]);
    }
