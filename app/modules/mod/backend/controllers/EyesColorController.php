...
use modules\mod\common\models\EyesColorSearch;
...
/**
 * EyesColorController implements the CRUD actions for EyesColor model.
 */
class EyesColorController extends Controller
{
    ...
    /**
     * Lists all EyesColor models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new EyesColorSearch();
    ...
    /**
     * Updates an existing EyesColor model.
    ...
    /**
     * Deletes an existing EyesColor model.
    ...
    /**
    * Deletes an existing EyesColor models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    ...
    */
    ...
    /**
     * Finds the EyesColor model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return EyesColor the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EyesColor::findOne($id)) !== null) {
            return $model;
        } else {
