        ...
        <?php if ($this->params['showCategories']) : ?>
          <ul class="b-categories b-header__categories">
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/1.png" alt="Детский мир"
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/2.png"
                       alt="Запчасти для автомобиля" class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/3.png" alt="Дом и сад"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/4.png" alt="Мода и стиль"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/5.png" alt="Недвижемость"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/6.png" alt="Работа"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/7.png" alt="Электроника"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/8.png"
                       alt="Хобби, отдых и спорт" class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/9.png" alt="Транспорт"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="javascript:void(0)">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/10.png" alt="Животные"
                       class="b-category__img">
                </div>
            ...
            <li class="b-category b-categories__category">
              <a class="b-category__link" href="categories.html">
                <div class="b-category__img-wrp">
                  <img src="<?= Yii::$app->theme->getAssetsUrl($this) ?>/img/tmp/categories/11.png"
                       alt="Бизнес и услуги" class="b-category__img">
                </div>
