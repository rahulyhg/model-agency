        ...
        <?php if ($this->params['showSearchForm']) : ?>
          <form action="search" class="b-search b-header__search">
            <label for="search-inquiry" class="b-field b-search__field">
              <input type="text" name="search-inquiry" placeholder="<?= Yii::t('header', 'Поиск по фразам') ?>" autocomplete="off"
            ...
            <button type="submit" class="b-button-second b-search__button">
              <span
                  class="b-button-second__value b-button-second__value_bold b-button-second__value_lighten"><?= Yii::t('header', 'Найти') ?></span>
            </button>
          </form>
        <?php endif; ?>
