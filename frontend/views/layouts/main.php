    ...
    <div class="b-sidebar__inner">
      <header class="b-sidebar__header">
        <div class="b-logo b-sidebar__logo">
          <a class="b-logo__link" href="<?= \yii\helpers\Url::to(['/']) ?>">
      ...
      <nav class="b-menu b-sidebar__menu">
        <ul class="b-menu__items">
          <li class="b-menu__item b-menu__item_active"><a class="b-menu__item-link" href="index.html">Home</a></li>
          <li class="b-menu__item"><a class="b-menu__item-link" href="our-models.html">Our models</a></li>
          <li class="b-menu__item"><a class="b-menu__item-link" href="contacts.html">Contacts</a></li>
        </ul>
      </nav>
      ...
      <div class="b-header__inner">
        <div class="b-header__left">
          <div class="b-toggle b-header__sidebar-toggle">
            <div class="b-toggle__items"><i
                  class="b-toggle__item b-toggle__item_active b-link__icon_lg fas fa-bars"></i><i
                  class="b-toggle__item b-link__icon_lg fas fa-times"></i></div>
          </div>
        </div>
        <div class="b-header__middle">
          <div class="b-logo-sm b-header__logo-sm">
            <a class="b-logo-sm__link" href="index.html">
        ...
        <div class="b-header__right"><a class="b-link b-header__login" href="login-model.html"><i
                class="b-link__icon b-link__icon_lg fas fa-user-ninja"></i></a><a class="b-link b-header__login"
                                                                                  href="login-user.html"><i
                class="b-link__icon b-link__icon_lg fas fa-user-tie"></i></a></div>
      </div>
    </header>
    <main class="b-main b-content__main">
      <nav class="b-nav-line b-main__nav-line">
        <div class="b-nav-line__left"><a class="b-link b-nav-line__bread-crumbs" href="index.html"><i
                class="b-link__icon fas fa-home"></i><span class="b-link__texts"><span
                  class="b-link__text-first">Home</span></span></a></div>
        <div class="b-nav-line__right"><a class="b-link b-nav-line__login" href="login-model.html"><i
                class="b-link__icon fas fa-user-ninja"></i><span class="b-link__texts b-link__texts_underline"><span
                  class="b-link__text-first b-link__text-first_uppercase">Models </span><span
                  class="b-link__text-second b-link__text-first_uppercase">sign in</span></span></a><a
              class="b-link b-nav-line__login" href="login-user.html"><i class="b-link__icon fas fa-user-tie"></i><span
                class="b-link__texts b-link__texts_underline"><span class="b-link__text-first">User </span><span
                  class="b-link__text-second">sign in</span></span></a></div>
      </nav>
